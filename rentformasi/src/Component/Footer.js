                    ...
                    <div className="footer">
                        ...
                        <div className="footer-bottom">
                            <div className="footer-bottom-left">
                                <div>Created with love by Elastic Themes</div>
                            </div>
                            <div className="footer-bottom-right">
                                <div>Powered by Webflow</div>
                                <div className="footer-bottom-divider"></div><div className="link-white">Style Guide</div>
                                <div className="footer-bottom-divider"></div><div className="link-white">Licensing</div></div>
                        </div>
                    </div>
                </div>
            </div>
