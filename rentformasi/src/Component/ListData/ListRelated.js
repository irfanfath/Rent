            ...
            <div className="section">
                <div className="wrapper">
                    <div className="shop-header">
                        <h3>Related Products</h3><a href="/catalog" className="link arrow-link">Lihat Semua</a>
                    ...
                    <div className="full-width w-dyn-list">
                        <div className="products w-dyn-items">
                            <div data-w-id="df75c36d-8d89-3a15-6c0d-6078372525bd" className="product-card-wrapper w-dyn-item">
